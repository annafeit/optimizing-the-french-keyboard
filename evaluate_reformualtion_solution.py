...
def evaluate_optimized_reformulation(w_p, w_a, w_f, w_e, level_cost, corpus_weights, quadratic=1):
    """
    ...
    #create plot
    plot_mapping(mapping, plotname=newest+".png", w_p=w_p, w_a=w_a, w_f=w_f, w_e=w_e, level_cost=level_cost, corpus_weights=corpus_weights, quadratic=1)